    ...
    return (
      <div className="App">
        ...
        {users.map(function(item) {
          return (
            <div key={item.id} className="card">
              <div className="card-body">
                ...
                <p className="card-text">{item.address.street}</p>
                <a href={item.email} className="card-link">
                  {item.name}
                </a>
                <a href={item.website} className="card-link">
                  {item.website}
                </a>
              </div>
            </div>
          ...
          //     </span>
          //     <span className="badge badge-secondary">{item.username}</span>
          //     <span className="badge badge-secondary">{item.email}</span>
          //     <span className="badge badge-secondary">{item.phone}</span>
          ...
          //     </span>
          //     <span className="badge badge-secondary">{item.company.bs}</span>
          //   </h5>
          // </div>
        })}

        {posts.map(function(msg) {
          // console.log("ye dekho");
          // console.log(msg);
          return (
            <div key={msg.id}>
              <h5>
                <span className="badge badge-light">{msg.userId}</span>

                <span className="badge badge-secondary">{msg.title}</span>
                <span className="badge badge-secondary">{msg.body}</span>
              </h5>
            </div>
          );
        })}
